...
def gamma4_predict_deaths(U, V, pred_gammas, forward, delta1, delta2):
	'''
	Function that predicts hospitalizations several days ahead
	assuming the 4-gamma infection dynamics model. 
...
def gamma4_predict_cases(U, V, pred_gammas, forward, delta1, delta2):
	'''
	Function that predicts hospitalizations several days ahead
	assuming the 4-gamma infection dynamics model. 
